...
public class CatalogoAsientos extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        d.setNumeroAsiento(Integer.parseInt(txtNumeroAsiento.getText()));
        d.setCostoVenta(Long.parseLong(txtCostoAsiento.getText()));
        if(rbPRE.isSelected()){
            d.setCodigoArea(rbPRE.getText());
        } else {
            d.setCodigoArea(rbNOR.getText());
        }
